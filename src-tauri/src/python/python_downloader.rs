...
pub async fn download_python(runtimes_folder: &PathBuf) -> Result<PathBuf> {
    ...
    download_file("https://github.com/indygreg/python-build-standalone/releases/download/20240224/cpython-3.12.2+20240224-i686-pc-windows-msvc-shared-install_only.tar.gz", &archive).await?;
