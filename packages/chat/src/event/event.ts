...
export const events = {
    ...
    MessageCreate: new EventKey<[Message]>(
        'on_message',
        initTableEvent((client) => client.messages),
    ),
    ...
    AuthorCreate: new EventKey<[Author]>(
        'on_author_create',
        initTableEvent((client) => client.authors),
    ),
    ...
    ChannelCreate: new EventKey<[Channel]>(
        'on_channel_create',
        initTableEvent((client) => client.channels),
    ),
    ...
    ProviderCreate: new EventKey<[Provider]>(
        'on_provider_create',
        initTableEvent((client) => client.providers),
    ),
    ...
    RoomCreate: new EventKey<[Room]>(
        'on_room_create',
        initTableEvent((client) => client.rooms),
    ),
